...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Atmosphere: soft top glow, faded grid, vignette */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-grid opacity-[0.5] mask-fade-b" />
        <div className="absolute left-1/2 top-[-10%] h-[60vh] w-[80vw] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.06),transparent_65%)] blur-2xl" />
      ...
      >
        ...
        >
          <motion.span
            variants={fadeUp}
            className="inline-flex w-fit items-center gap-2.5 rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs tracking-tight text-mist"
          >
